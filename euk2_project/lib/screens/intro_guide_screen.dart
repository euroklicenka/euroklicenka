...
class IntroGuideScreen extends StatelessWidget {
  ...
  final List<PageViewModel> pages = [
    PageViewModel(
        ...
        body:
            'Pokud jste majitelem Euroklíče, můžete použít aplikaci EuroKlíčenka k nalezení nejbližšího sociálního zařízení, které Euroklíč umí otevřít.Euroklíče distrubuuje Národní rada osob se zdravotním postižením ČR.',
    ...
    PageViewModel(
        ...
        body:
            'akjfkjdhjksdhfkjasdhfkajsdhfkjasdhfkjasdhfkjasdhfkjasdhfkasjdfhaksdjf',
        footer: const SizedBox(
          height: 45,
          width: 300,
        ),
    ...
    PageViewModel(
      ...
      body:
          'Za vývojem aplikace stojí studentí z Katedry informatiky a počítačů, Přírodvědecké fakulty Ostravské univerzity.'
