...
class ClusteredEUKLocationManager extends EUKLocationManager {
 late ClusterManager<EUKLocationData> _clusterManager = ClusterManager<
      EUKLocationData>(
  ...
  Future<void> _buildMarkers() async {
    ...
    final List<Cluster<EUKLocationData>> clusters = _clusterManager
        .getMarkers() as List<Cluster<EUKLocationData>>;
...
//   return ClusterManager<EUKLocationData>(items, _updateMarkers,
